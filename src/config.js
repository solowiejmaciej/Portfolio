    ...
    technologies: [
      {
        name: "Backend",
        icon: Terminal,
        tools: [".NET", "RabbitMQ", "Docker", "WebAPI"],
      },
      {
        name: "Frontend",
        icon: Code2,
  ...
  projects: [
    {
      ...
      details: {
        overview: [
          ...
          "Designed and developed RESTful APIs for managing devices and users.",
        ...
        technical: [
          ...
          },
          {
            ...
            description: ".NET, WebAPI, Entity Framework, PostgreSQL, RabbitMQ",
          },
          {
            type: "database",
            title: "Database",
